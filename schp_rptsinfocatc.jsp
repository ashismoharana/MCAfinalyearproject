...
<center><font color="black" size="5" >Service Information [Any Serv.Cat.Name]</center>
<br>

<form name="f1" action="schp_rptsinfocats.jsp" method="get"><center>
...
<td>
<select name="cmbsname">
<option value=" ">-Select-</option>
<%
doConnect();
try{
stmtFill=conn.createStatement();
rsFill=stmtFill.executeQuery("select * from schp_tblservice");
while(rsFill.next()) {
sname=rsFill.getString("servtypname");
%>
