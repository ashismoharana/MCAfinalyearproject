...
<center><font color="black" size="5" >Health Centre Information [Any City]</center>
<br>

<form name="f1" action="schp_rpthcentercitys.jsp" method="get"><center>

<br><br>
<center>
<table width="400" border="0">
<tr>
<td> Health Centre city :</td>
<td>
<select name="cmbcity">
