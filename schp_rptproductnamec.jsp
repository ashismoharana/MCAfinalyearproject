...
<center><font color="black" size="5" >Product Information [Any Prod.Name]</center>
<br>

<form name="f1" action="schp_rptproductnames.jsp" method="get"><center>
