...
<sub>
 ...
 Service Category Information</font>
</td></tr></table></center>
...
<td><font color="white">Service Category Code</td>
...
<%
 ...
 try{ 
  ...
  rscode=stmtselect.executeQuery("select * from schp_tblservtype");
  slno=1;
  
  while(rscode.next()){
  sCatCode=rscode.getString("servtypecode");
  sCatName=rscode.getString("servtypename");
 if(slno % 2 == 1)
