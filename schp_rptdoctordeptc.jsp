...
<center><font color="black" size="5" >Doctor's Information [Any Department]</center>
<br>

<form name="f1" action="schp_rptdoctordepts.jsp" method="get"><center>
