...
<center><font color="black" size="5" >Product Information [Any Prod.Category]</center>
<br>

<form name="f1" action="schp_rptproductcats.jsp" method="get"><center>
...
<td>
<select name="cmbprocat">
<option value=" ">-Select-</option>
<%
doConnect();
try{
stmtFill=conn.createStatement();
rsFill=stmtFill.executeQuery("select * from schp_tblproductinfo");
while(rsFill.next()) {
ProdCatCode=rsFill.getString("prodcat");
%>
